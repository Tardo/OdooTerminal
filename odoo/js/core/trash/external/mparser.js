/*
 Original code from: https://silentmatt.com/parser3.js
 Based on ndef.parser, by Raphael Graf(r@undefined.ch)
 http://www.undefined.ch/mparser/index.html

 Modified to be used in OdooTerminal by Alexandre D. Díaz
*/
odoo.define("terminal.external.mparser", function (require) {
    "use strict";
    ...
    var Parser = (function () {
                ...
                for (i = 0; i < L; i++) {
                    ...
                    if (type_ === TNUMBER) {
                        ...
                        if (result && typeof result[0] !== "undefined") {
                            ...
                            throw new Error(
                                "undefined variable: " + item.index_
                            );
                        }
                    } else if (type_ === TOP1) {
                        n1 = nstack.pop();
        ...
        Parser.prototype = {
            ...
            addfunc: function (tokenstack, operstack, type_) {
                ...
                while (operstack.length > 0) {
                    if (
                        operator.prio_ <= operstack[operstack.length - 1].prio_
                    ) {
            ...
            isConst: function () {
                ...
                for (var i in this.consts) {
                    if (true) {
                        var L = i.length;
                        str = this.expression.substring(this.pos, L);
                        if (i === str) {
